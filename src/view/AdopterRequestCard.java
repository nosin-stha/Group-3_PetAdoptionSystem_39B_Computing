...
public class AdopterRequestCard extends javax.swing.JPanel {
    ...
    public AdopterRequestCard(AdoptionRequestData req) {
        initComponents();
        PetImgRequestCard.setPreferredSize(new java.awt.Dimension(75, 75));
        PetImgRequestCard.setMinimumSize(new java.awt.Dimension(75, 75));
        PetImgRequestCard.setMaximumSize(new java.awt.Dimension(75, 75));
    }
